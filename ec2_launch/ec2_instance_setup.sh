...
EC2_RUN_RESULT=$(ec2-run-instances --instance-type t2.micro --group default --region us-west-1 --key $EC2_INSTANCE_KEY --block-device-mapping "/dev/sda1=:8:true" --instance-initiated-shutdown-behavior stop --user-data-file instance_installs.sh ami-062f7200baf2fa504)
